exports.sendOutOfStockEmail = function (name, email, productName) {
        ...
        try {
            ...
            <body>
                ...
                <div class="container mt-3 mb-5">
                    <div class="p-3">
                        <div>Hello ${name},</div>
                        <p>The product <b>${productName}</b> that you created is now out of stock.</p>
                        <p>Please take necessary actions to update or restock the product.</p>
                        <div class="mb-3 text-justify mt-3">
                          <span class="text-dark">
                              Please do not show or forward this message to third parties.
                          </span>
                          <br><br>
                          <span class="text-dark">
          ...
          `;
            console.log("Sending out-of-stock email to:", email);
            await sendEmail(email, 'Product Out of Stock Notification', template);
            resolve(true);
        } catch (error) {
            console.error('Error generating or sending out-of-stock email:', error);
            reject(error);
        }
    });
};
